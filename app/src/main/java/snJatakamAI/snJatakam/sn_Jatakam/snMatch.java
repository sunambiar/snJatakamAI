...
public class snMatch {
  ...
  static snPrintWriter pS = null, pP = null, pM = null, pI = null;
 ...
 /*------------------------------------------------------------------*/
  ...
  /*------------------------------------------------------------------*/
  public snMatch(snPrintWriter wP, snPrintWriter wS, snPrintWriter wM, snPrintWriter wI,
  ...
  private void get_snMatch(String ArgsB[], int detail, String ArgsG[],
    ...
    if (!snServlet) {
      ...
      try {
        pI = new snPrintWriter(new FileOutputStream(idxFname));
      } catch (Exception e) {
      } finally {
        if (snIOglobalSetting.getPrintWriterOn()) {
          snPrintWriter.enable(pI);
        } else {
          snPrintWriter.disable(pI);
        }
      }
    }
    ...
    if (outOpt == 'F' || snServlet) {
      ...
      if (outOpt == 'F') {
        ...
        /*for (int kx = 0; kx < 2; kx++)*/ {
          try {
            pS = new snPrintWriter(new FileOutputStream(ofname));
          } catch (Exception e) {
        ...
        //pI = snPrintWriter (Passed Value)
        //pP = snPrintWriter (Passed Value)
        //pS = snPrintWriter (Passed value)
      }
  ...
  /*------------------------------------------------------------------*/
  private void printOutKalams(manushya p, manushya s, snPrintWriter pS) {
  ...
  /*------------------------------------------------------------------*/
  private void reports(manushya p, manushya s, snPrintWriter pS) {
    boolean dosham;
  ...
  /*---------------------------------------------------------------*/
  private void detail_report(manushya p, manushya s, snPrintWriter pS) {
    hWrite("<TR><TD><STRONG>");
  ...
  /*---------------------------------------------------------------*/
  private void printDasaSandhis(manushya p, manushya s, snPrintWriter pS) {
    int i;
    //hWrite("<TR><TD><STRONG>");
  ...
  /*---------------------------------------------------------------*/
  private void listPaapas(manushya p, manushya s, snPrintWriter pS) {
